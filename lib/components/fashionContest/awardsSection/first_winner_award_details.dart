...
class FirstWinnerAwardDetails extends StatelessWidget {
  const FirstWinnerAwardDetails({super.key});
              ...
              Row(
                children: [
                  ...
                  SizedBox(
                    width: 240.w,
                    child: Text(
                      contestAwardsController.firstWinnerAwards[0],
                      overflow: TextOverflow.ellipsis,
              ...
              Row(
                children: [
                  ...
                  SizedBox(
                    width: 240.w,
                    child: Text(
                      contestAwardsController.firstWinnerAwards[1],
                      overflow: TextOverflow.ellipsis,
                      style: contestAwardDetailStyles,
                    ),
                  ),
              ...
              Row(
                children: [
                  ...
                  SizedBox(
                    width: 300.w,
                    child: Text(
                      contestAwardsController.firstWinnerAwards[2],
                      overflow: TextOverflow.ellipsis,
                      style: contestAwardDetailStyles,
                    ),
                  ),
