...
class CountryList extends StatelessWidget {
  ...
  static final countrySelectionController =
      Get.put(CountrySelectionController());
      ...
      itemBuilder: (context, index) {
        ...
        return CupertinoButton(
          ...
          onPressed: () {
            ...
            countrySelectionController.setSelectCountry(index);
            Navigator.of(context).pop();
            Get.off(const LoginScreen());
            showSnackBar(context,
                "${countrySelectionController.selectedCountryName} selected successfully !");
          },
          child: Column(
            children: [
              Row(
