...
import 'package:sample/controllers/countrySelection/country_selection_controller.dart';
import 'package:sample/packages/flush_bar_method.dart';
import 'package:sample/components/auth/bottom_help_menu.dart';
...
class RegisterContents extends StatelessWidget {
  ...
  static final countrySelectionController =
      Get.put(CountrySelectionController()); // Password controller
        ...
        children: [
          ...
          SizedBox(
            ...
            child: CupertinoTextField(
              ...
              placeholder:
                  "(+${countrySelectionController.selectedCountryCode}) xxx-xxx-xxxx",
